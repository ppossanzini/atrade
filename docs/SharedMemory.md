...
- Report a requirement the application cannot measure as `NotVerifiable`, never as satisfied because nothing contradicts it; and never treat an empty history as evidence that a period went well.
